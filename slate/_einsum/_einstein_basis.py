...
from slate.basis._tuple import TupleBasis, TupleBasisLike, is_tuple_basis_like
from slate.metadata import NestedLength
...
class EinsumBasisHints:
    def __init__(self) -> None:
        self._single_map = defaultdict[str, set[Basis]](set)
        self._diag_map = defaultdict[tuple[str, ...], set[Basis]](set)
